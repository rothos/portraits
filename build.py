...
def generate_gallery(header, folder_name, gallery_id):
    ...
    for filename in files:
        global ignore_list
        if filename.endswith(".png") and filename not in ignore_list and not filename.endswith("t.png"):
            global total_images
...
def generate_html():
    ...
    top_text = """<p>As an ongoing art project, I sometimes ask people to draw me.
        Currently, I have a total of %i portraits collected on this page.</p>
        <p>For details about how I created this gallery and processed the images,
        see the very bottom of the page.</p>\n""" % total_images
